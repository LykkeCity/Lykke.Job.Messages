    ...
    public class CqrsModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var rabbitMqSettings = new RabbitMQ.Client.ConnectionFactory
                {Uri = _settings.CurrentValue.MessagesJob.Transports.ClientRabbitMqConnectionString};
            ...
            builder.RegisterType<SpecialSelfieSupportNotificationSaga>()
                .SingleInstance()
                .WithParameter("selfieUrl", _settings.CurrentValue.SpecialSelfieSettings.SelfieUrl)
                .WithParameter("supportEmail", _settings.CurrentValue.SpecialSelfieSettings.SupportEmail);
            ...
            builder.Register(ctx =>
                {
                    ...
                    var engine = new CqrsEngine(logFactory,
                        ...
                        Register.Saga<BlockchainOperationsSaga>("blockchain-notification-saga")
                            ...
                            .On(eventsRoute)
                            .ProcessingOptions(eventsRoute).MultiThreaded(2).QueueCapacity(512)
                            .ListeningEvents(typeof(SiriusDepositsDetector.Contract.Events.CashinCompletedEvent))
                            .From(SiriusDepositsDetector.Contract.SiriusDepositsDetectorBoundedContext.Name)
                            .On(eventsRoute)
                            .ProcessingOptions(eventsRoute).MultiThreaded(2).QueueCapacity(512)
                            .ListeningEvents(typeof(SiriusCashoutProcessor.Contract.Events.CashoutCompletedEvent))
                            .From(SiriusCashoutProcessor.Contract.SiriusCashoutProcessorBoundedContext.Name)
                            .On(eventsRoute)
                            .ProcessingOptions(eventsRoute).MultiThreaded(2).QueueCapacity(512)
                        ...
                        Register.Saga<LykkePayOperationsSaga>("lykkepay-employee-registration-notifications-saga")
                            .ListeningEvents(typeof(EmployeeRegistrationCompletedEvent),
